...
public enum ConfigNodes {
	...
	WAR_SIEGE_BANNER_CONTROL_VERTICAL_DISTANCE_DOWN_BLOCKS(
			...
			"# Note that the horizontal distance is always the same as the Towny townblock size."),
	WAR_SIEGE_TELEPORTATION(
			"war.siege.teleportation",
			"",
			"",
			"",
			"############################################################",
			...
			"############################################################",
			""),
	WAR_SIEGE_TELEPORTATION_BLOCK_INCOMING_SIEGEZONE_TELEPORTS(
			"war.siege.teleportation.block_incoming_siegezone_teleports",
			"true",
			"",
			"# If true, then nobody can teleport into Siege-Zones, ",
			"# except town residents spawning into their own towns.",
			"# TIP: This setting:",
			"# * Protects players from accidentally spawning into a warzone while unprepared, ",
			"     particularly peaceful town members who will get war sickness damage and may be unable to teleport out.",
			"# * Discourages 'fake' sieges, by making the siege impact harsher.",
			"# * Simulates the realistic dynamic of a besieged town being cut off from the outside.", 
			"# * Encourages the siege-sides to think about military logistics"), 
	WAR_SIEGE_TELEPORTATION_REDIRECT_SIEGEZONE_LOGINS(
			"war.siege.teleportation.redirect_siegezone_logins",
			"true",
			"",
			"# If true, then all Siege-Zone logins are redirected: ",
			"# * Siege-Participant: Redirected to the nearest town in the Siege-Zone which belongs to their siege side and is public.",
			"# * Non-Siege-Participant: Redirected to the nearest public non-enemy town, X blocks.",
			"# * If no suitable redirect is found, the player is redirected to their own town",
			"# TIPS: ",
			"# * This setting prevents players from unrealistic ambushes by logging off/on at the Siege Banner.",
			"# * This setting is critical for the Wall Breaching feature, to prevent players logging off/on at the homeblock for ez Wall Breach Bonuses."),
	WAR_SIEGE_TELEPORTATION_REDIRECT_SIEGEZONE_RESPAWNS(
			"war.siege.teleportation.redirect_siegezone_respawns",
			"true",
			"",
			"# If this setting is true, then if a Siege Participant dies in the Siege-Zone,",
			"# they get Redirected to the nearest town in the Siege-Zone which belongs to their siege side and ispublic.",
			"# TIP: This setting helps keep battles fun,",
			"# by helping players get right back into the action a few seconds after respawning."), 
